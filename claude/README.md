...
Builds mental model study guides for LeetCode problems using a single powerful analogy.
...
**What it does:**
- Builds deep understanding through ONE carefully chosen real-world analogy
- Defends why the chosen analogy is the perfect fit
- Creates study guides in `/Users/snesjhon/Developer/snesjhon/ysk/study-guides/`
- Uses mermaid charts for visualizations (trees, graphs, state machines)
- Validates all mermaid charts with `mmdc` before completion
- Includes TypeScript solutions with analogy-based variable naming
- Stays within the analogy throughout the entire explanation
