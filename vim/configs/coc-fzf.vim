...
" Same modal nav as :Files/:Rg (configs/fzf.vim's FzfModalNavBinds), deferred to VimEnter for load order.
" --wrap mirrors :Rg's fix in configs/fzf.vim -- coc-fzf's lists (grr/gd/gy/gi jumps, outline,
